...
all_spheres = construct_spheres(progression_data)

for sphereNum in all_spheres.keys():
    print(sphereNum, "maps:", all_spheres[sphereNum].maps, "items:", all_spheres[sphereNum].items)
